...
export function IslandNavbar() {
  ...
  return (
    <header className="fixed left-1/2 top-6 z-50 w-[min(92vw,760px)] -translate-x-1/2">
      <nav className="relative flex items-center justify-between rounded-full border border-white/10 bg-white/5 px-3 py-2 shadow-[0_8px_28px_rgba(255,255,255,0.04)] backdrop-blur-xl">
        ...
        <Link
          ...
          className="rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm font-semibold tracking-wide text-white/90 transition hover:bg-white/20"
        >
          Portfolio
        </Link>
        ...
        <div className="flex items-center gap-2">
          <a
            href="/Gopi_SURESH-alternance.pdf"
            download
